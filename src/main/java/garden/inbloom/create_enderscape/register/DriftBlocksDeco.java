...
public class DriftBlocksDeco {
	...
	public static final DeferredBlock<MetalScaffoldingBlock> DUSK_SCAFFOLDING = registerDecoBlock("dusk_scaffolding",
		() -> new MetalScaffoldingBlock(BlockBehaviour.Properties.ofFullCopy(DriftBlocks.DUSK_CASING.get())));
	...
	protected static <T extends Block> DeferredBlock<T> registerDecoBlock(String name, Supplier<T> block) {
        return DriftBlocks.registerDecoBlock(name, block);
    }
	//endregion
